  ...
  return (
    <main className="p-4">
      ...
      <div className="glass rounded-2xl p-6 mb-4 relative overflow-hidden">
        ...
        <p className="text-center text-xs text-ink-muted mt-1 relative">ETA ~{data?.matches?.[0]?.eta_minutes || 25} min</p>
      </div>
      <div className="space-y-2">
        {STEPS.map((s, i) => (
          ...
          >
            <MapPin size={16} className={i <= step ? "text-brand-600" : "text-ink-faint"} />
